C++ code for finding the distance between words. Distance is defined as the shortest path between the words (two words are connected if they differ exactly at one letter).
